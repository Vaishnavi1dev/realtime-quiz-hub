...
class GeminiService {
  constructor() {
    ...
    try {
      ...
      console.log('✅ Gemini service initialized with gemini-1.5-flash model');
      this.isEnabled = true;
    } catch (error) {
...
`;
    ...
    try {
      ...
      // If Gemini API fails, provide a helpful error but also a fallback
      console.error('❌ Gemini API completely failed:', error.message);
      
      // Provide a working fallback so the feature isn't completely broken
      return {
        title: `${topic} Quiz - ${difficulty.charAt(0).toUpperCase() + difficulty.slice(1)} (Demo)`,
        questions: Array.from({ length: questionCount }, (_, i) => ({
          ...
          correctAnswer: 0,
          explanation: `This demonstrates a key concept in ${topic}. In a real quiz, this would be generated by AI.`
        }))
      };
    }
  }
